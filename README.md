...
```shell
  docker buildx build -t kimalena9/dockiq-extension:latest . --load
```

To install the extension, use `make install-extension` **or**:

```shell
  docker extension install kimalena9/dockiq-extension:latest
```
...
```shell
  docker extension dev ui-source kimalena9/dockiq-extension:latest http://localhost:3000
```

In order to open the Chrome Dev Tools for your extension when you click on the extension tab, run:

```shell
  docker extension dev debug kimalena9/dockiq-extension:latest
```

Each subsequent click on the extension tab will also open Chrome Dev Tools. To stop this behaviour, run:

```shell
  docker extension dev reset kimalena9/dockiq-extension:latest
```
...
```shell
docker extension update kimalena9/dockiq-extension:latest
```
...
```shell
docker extension rm kimalena9/dockiq-extension:latest
```
